...
class Competence{
	...
	protected static $tbl_name = "competences";
	function db_fields(){
		global $mydb;
...
*/
	...
	function single_competence($id=0){
			global $mydb;
			$mydb->setQuery("SELECT * FROM ".self::$tbl_name." Where competence_id= {$id} LIMIT 1");
