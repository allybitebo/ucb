<?php
	...
	*/
	...
	class Sector{
		...
		protected static $tbl_name = "sectors";
		function db_fields(){
			global $mydb;
			return $mydb->getFieldsOnOneTable(self::$tbl_name);
		}
		
		/*function find_all_sector$project_name="", $course_level="",$course_major="" ){
			global $mydb;
		...
		function single_sector($id=0){
			global $mydb;
			$mydb->setQuery("SELECT * FROM ".self::$tbl_name." Where sector_id = {$id} LIMIT 1");
