<div class="wells">
				<h3 align="left">List of Schools</h3>
		...
		<div class="form-group">
			<div class="col-md-8">
				<label class="col-md-4 control-label" for="address">New School:</label>
				<div class="col-md-4" >
					<li class="leaf"><a href="<?php echo WEB_ROOT; ?>admin/modules/school/index.php?view=add"> Add </a></li>
				</div>
			</div>
		</div>
				<?php 
