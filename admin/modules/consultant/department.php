	...
	<ul>
		...
		$school_id = $_GET['sid'];
			...
			foreach ($departmentList as $list) {
				echo '<li>';
				echo '<a href = "index.php?view=listOfConsultants&did='. $list->department_id. '&department_name='. $list->name . '" class="button green"><strong class="title">' . $list->name .'</a></strong>';
				echo '</li>';
			}
		?>
	</ul>
