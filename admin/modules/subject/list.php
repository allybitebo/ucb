<div class="wells">
			    ...
			    <form action="controller.php?action=delete" Method="POST">  					
				  ...
				  <thead>
				  	<tr>
				  		<th>No.</th>
				  		<th width="15%" align="left"><input type="checkbox" name="chkall" id="chkall" onclick="return checkall('selector[]');"> Subject #</th>
				  		<th>Subject name</th>
				  		<th>Description</th>
						<th>Edit</th>
						<th>Details</th>
		...
		<div class="form-group">
			<div class="col-md-8">
				<label class="col-md-4 control-label" for="address">New Subject:</label>
				<div class="col-md-4" >
					<li class="leaf"><a href="<?php echo WEB_ROOT; ?>admin/modules/subject/index.php?view=add"> Add </a></li>
				</div>
			</div>
		</div>
				<?php 
