		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-xs-9">
					...
					<div class="col-xs-4">
						<div class="col-xs-6">
							<p align="left"><a href="<?php echo WEB_ROOT;?>admin/modules/subject/index.php?view=list" class="btn btn-info btn-xsm">
				...
				<div class="wells">
					...
					<form action="controller.php?action=delete" Method="POST">  					
						<table id="example" class="table table-striped" cellspacing="0">
							...
							//$mydb->setQuery("SELECT `subject_id` , `subject_number` ,`subject_name` FROM `subject`");
							//loadresult();
							...
							$domain_id = $_GET['sid'];
							$subject = new Subject();
							$subjectList = $subject->subjectFromDomain($domain_id);
							...
							echo '<td width="15%" ><a href = "index.php?view=edit&id='.$list->subject_id.'" ><span class="glyphicon glyphicon-list-alt"> </span>  Edit</a></td>';
