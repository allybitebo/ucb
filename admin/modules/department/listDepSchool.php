		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-xs-9">
					...
					<div class="col-xs-4">
						<div class="col-xs-6">
							<p align="left"><a href="<?php echo WEB_ROOT;?>admin/modules/department/index.php?view=list" class="btn btn-info btn-xsm">
				...
				<div class="wells">
					...
					<form action="controller.php?action=delete" Method="POST">  					
						<table id="example" class="table table-striped" cellspacing="0">
							...
							//$mydb->setQuery("SELECT `department_id` , `department_number` ,`department_name` FROM `departments`");
							//loadresult();
