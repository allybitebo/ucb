		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-xs-9">
					...
					<div class="col-xs-4">
						<div class="col-xs-6">
							<p align="left"><a href="<?php echo WEB_ROOT;?>officer/modules/project/index.php?view=ProjectConsultant" class="btn btn-info btn-xsm">
					...
					<fieldset>
						...
						<div class="form-group" id="project_id">
							<div class="col-md-8">
								...
								<div class="col-md-8">
									<?php
										if ($consultantInfos == "addConsultant")
										{
											echo '<p><strong>No Consultant Added to the Project</strong></p>';
											echo '<a href="index.php?view=addProjectConsultant&project_id='.$_GET['projectId'].'" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span> Add Consultant</a>';
											} else {
											echo '<a href="index.php?view=addProjectConsultant&project_id='.$_GET['projectId'].'" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span> Add Another Consultant</a>';
